...
//    var ratingColor: Int = Color.YELLOW,
        val adLabelTextStyle: NativeTextStyle = NativeTextStyle(12, Color.WHITE, Color.parseColor("#FFCC66")),
        val headlineTextStyle: NativeTextStyle = NativeTextStyle(16, Color.BLACK),
//    val advertiserTextStyle: NativeTextStyle = NativeTextStyle(14, Color.BLACK),
        val bodyTextStyle: NativeTextStyle = NativeTextStyle(12, Color.GRAY)
//    val storeTextStyle: NativeTextStyle = NativeTextStyle(12, Color.BLACK),
//    val priceTextStyle: NativeTextStyle = NativeTextStyle(12, Color.BLACK),
//    val callToActionStyle: NativeTextStyle = NativeTextStyle(15, Color.WHITE, Color.parseColor("#4CBE99"))
) {
    companion object {
